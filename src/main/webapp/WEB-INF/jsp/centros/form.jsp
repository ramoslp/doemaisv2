...
<body>
	...
	<div class="container">
	<h3>Adicionar Centro de Recolhimento</h3>
		<form action="executa?action=AddCentro" method="POST">
			Nome:<br>
			<input type="text" name="nome" required="required" /><br>
			CEP:<br>
			<input type="text" name="endereco.cep" required="required" /><br>
			Logradouro:<br>
			<input type="text" name="endereco.logradouro" required="required" /><br>
			Número:<br>
			<input type="text" name="endereco.numero" required="required" /><br>
			Complemento:<br>
			<input type="text" name="endereco.complemento" /><br>
			Telefone:<br>
			<input type="text" name="contato.telefone" required="required" /><br>
			E-mail:<br>
			<input type="email" name="contato.email" required="required" /><br>
			<br><br>
