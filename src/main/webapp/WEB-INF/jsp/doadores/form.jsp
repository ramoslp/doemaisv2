...
<body>
	...
	<div class="container">
		...
		<form action="executa?action=AddDoador" method="POST" role="form">
			<h3>Adicionar Doador</h3><br>
			...
			<div class="form-group">
				...
				<input type="text" name="cpf" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
				<label for="dataNascimento">Data de Nascimento</label>
				<input type="text" name="dataNascimento" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="endereco.cep" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
				<label for="endereco.logradouro">Endereço</label>
				<input type="text" name="endereco.logradouro" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
				<label for="endereco.numero">Número</label>
				<input type="text" name="endereco.numero" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
				<label for="endereco.complemento">Complemento</label>
				<input type="text" name="endereco.complemento" class="form-control" style="width:300px" />
			</div>
			<div class="form-group">
				<label for="contato.telefone">Telefone</label>
				<input type="text" name="contato.telefone" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
				<label for="contato.email">E-mail</label>
				<input type="text" name="contato.email" class="form-control" style="width:300px" required="required" />
			</div>
			<div class="form-group">
